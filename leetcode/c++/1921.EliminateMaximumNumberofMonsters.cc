...
*/
#include"1921.EliminateMaximumNumberofMonsters.h"
int main() 
 {
 	 Solution s;
	 vector<int> d1={1,3,4},s1={1,1,1};
 	 cout<<s.eliminateMaximum(d1,s1)<<endl;
	 vector<int> d2={1,1,2,4},s2={1,1,1,1};
 	 cout<<s.eliminateMaximum(d2,s2)<<endl;
 	 return 0;
 }
