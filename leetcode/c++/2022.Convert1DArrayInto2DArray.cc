...
*/
#include"2022.Convert1DArrayInto2DArray.h"
int main() 
 {
 	 Solution s;
	 vector<int> v={1,2,3,4};
 	 show(s.construct2DArray(v,2,2));
	 v.clear();v={1,2,3};
 	 show(s.construct2DArray(v,1,3));
	 v.clear();v={1,2};
 	 show(s.construct2DArray(v,1,1));
	 v.clear();v={3};
 	 show(s.construct2DArray(v,1,2));
 	 return 0;
 }
