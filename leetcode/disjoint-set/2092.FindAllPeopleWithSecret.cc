...
*/
#include"2092.FindAllPeopleWithSecret.h"
int main() 
 {
 	 Solution s;
	 vector<vector<int> > v={{1,2,5},{2,3,8},{1,5,10}};
 	 show(s.findAllPeople(6,v,1));
	 v.clear();v={{3,1,3},{1,2,2},{0,3,3}};
 	 show(s.findAllPeople(4,v,3));
	 v.clear();v={{3,4,2},{1,2,1},{2,3,1}};
 	 show(s.findAllPeople(5,v,1));
 	 return 0;
 }
