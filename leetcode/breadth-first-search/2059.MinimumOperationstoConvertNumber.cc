...
*/
#include"2059.MinimumOperationstoConvertNumber.h"
int main() 
 {
 	 Solution s;
	 vector<int> v={1,3};
 	 cout<<s.minimumOperations(v,6,4)<<endl;
	 v.clear();v={2,4,12};
 	 cout<<s.minimumOperations(v,2,12)<<endl;
	 v.clear();v={3,5,7};
 	 cout<<s.minimumOperations(v,0,-4)<<endl;
	 v.clear();v={2,8,16};
 	 cout<<s.minimumOperations(v,0,1)<<endl;
	 v.clear();v={1};
 	 cout<<s.minimumOperations(v,0,3)<<endl;
 	 return 0;
 }
