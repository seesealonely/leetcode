...
{
//	Solution s;
//	vector<vector<Node *>> quadTree1 = {{0,1},{1,1},{1,1},{1,0},{1,0}},quadTree2 = {{0,1},{1,1},{0,1},{1,1},{1,0},NULL,NULL,NULL,NULL,{1,0},{1,0},{1,1},{1,1}};
//	show(s.intersect(quadTree1,quadTree2));
//	quadTree1.clear();quadTree2.clear();
//	quadTree1={{1,0}};
//	quadTree2={{1,0}};
//	show(s.intersect(quadTree1,quadTree2));
	return 0;
